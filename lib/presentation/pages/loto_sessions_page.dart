...
class LotoSessionsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => sl<LotoSessionsCubit>()..fetchSessions()),
                            ...
                            builder: (context, state) {
                              ...
                              if (state is StorageSynced) {
                                final warehouses = List<StorageEntity>.from(
                                  ...
                                  (a, b) =>
                                      a.warehouseId.compareTo(b.warehouseId),
                                );
                                  ...
                                  BlocBuilder<ManpowerCubit, ManpowerState>(
                                    builder: (context, manpowerState) {
                                      ...
                                      if (manpowerState is ManpowerSynced) {
                                        final fuelmen = List.of(
                                          manpowerState.fuelmen,
                                        )..sort(
                                          (a, b) => (a.nama ?? a.nrp).compareTo(
                                            b.nama ?? b.nrp,
                                          ),
                                        );
                                        final operators = List.of(
                            ...
                            builder: (context, manpowerState) {
                              return ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  final remoteCount =
                                      state.remoteCounts[session.nomor] ?? 0;
                                  final localCount =
                                      state.localCounts[session.nomor] ?? 0;

                                  if (state.filterStatus == 'Submitted' &&
                                      remoteCount == 0) {
                                  ...
                                  if (manpowerState is ManpowerSynced) {
                                    final fuelmanEntity =
                                        manpowerState.fuelmen
                                            .where(
                                              (e) => e.nrp == session.fuelman,
                                            )
                                            .firstOrNull;
                                    if (fuelmanEntity != null) {
                                      fuelmanDisplay =
                                          fuelmanEntity.nama ?? session.fuelman;
                                    }
                                    ...
                                    child: GlassPanel(
                                      onTap: () async {
                                        ...
                                        if (result != null &&
                                            ...
                                            context.mounted) {
                                          final nomor =
                                              result['nomor'] as String?;
                                          final remote =
                                              result['remote'] as int?;
